...
s
        ...
        pillar_context = [F.interpolate(context_features, scale_factor=0.5, mode='bilinear', align_corners=False, recompute_scale_factor=False),
                          F.interpolate(context_features, scale_factor=0.25, mode='bilinear', align_corners=False, recompute_scale_factor=False),
                          F.interpolate(context_features, scale_factor=0.125, mode='bilinear', align_corners=False, recompute_scale_factor=False)]
