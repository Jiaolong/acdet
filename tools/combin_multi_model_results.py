...
path_pp = "/home/wangguojun/source_code/OpenPCDet/output/cfgs/kitti_models/cyv_det_metav6_fuse2_raw_transformer_mask_test_cyclist_ped_up2/up2_50"
path_se = "/home/wangguojun/source_code/OpenPCDet/output/cfgs/kitti_models/cyv_det_metav6_fuse2_raw_transformer_mask_test_cyclist_ped_up2/up2_49"
save_path = "/home/wangguojun/source_code/OpenPCDet/output/cfgs/kitti_models/cyv_det_metav6_fuse2_raw_transformer_mask_test_cyclist_ped/meta_v4_v6_reduce_v5_train_split_finetune_v4_ped_v5_cyc_ped_parta"
...
all_files = glob.glob(path_pp+"/*.txt")
...
for ann_file in all_files:
    ...
    file_path_m = ann_file
    file_path_u = os.path.join(path_se, file_name)
    ...
    cur_det_file = os.path.join(save_path, file_name)
    ...
    print("merge {} successful!".format(file_name))
